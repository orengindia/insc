		<div class="container stream">
			<div class="visible-xs col-xs-12 visible-lg col-lg-2 menu">
				...
				<div class="profile-counters">
					...
					<a href="<?php echo $profile_user; ?>/answers">
						...
						<span class="profile-info-label"><i class="fa fa-angle-double-right"></i> <?php get_text(169)?></span>
					</a>
			...
			<div class="col-xs-12 col-sm-8 col-lg-7">
				<h3 class="title">
					...
					<?php } ?>
					<?php echo $profile_name; ?> <?php get_text(273)?> <?php echo $answers; ?> <?php echo strtolower(get_text(243,1));?>
				</h3>
