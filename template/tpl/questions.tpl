		<div class="container stream">
			<div class="visible-xs col-xs-12 visible-lg col-lg-2 menu">
				...
				<div class="profile-counters">
					...
					<a href="<?php echo $profile_user; ?>/questions">
						...
						<span class="profile-info-label"><i class="fa fa-angle-double-right"></i> <?php echo ucfirst(get_text(196,1)); ?></span>
					</a>
					<a href="<?php echo $profile_user; ?>/points">
						<span class="profile-count-label"><?php echo $points; ?></span>
						<span class="profile-info-label"><?php get_text(39)?></span>
					</a>
				</div>
			</div>
			...
			<div class="col-xs-12 col-sm-8 col-lg-7">
				<h3 class="title">
					...
					<?php } ?>
					<?php echo $profile_name; ?> <?php echo strtolower(get_text(255,1));?> <?php echo $questions; ?> <?php echo strtolower(get_text(243,1)); ?>
				</h3>

				<input type="hidden" id="last_value" name="last_value" value="999999999">
				<input type="hidden" id="remain" name="remain" value="">
				<div class="loadingstream"><br><center><i class="fa fa-spinner fa-spin fa-3x" style="color:grey"></i></center></div>
