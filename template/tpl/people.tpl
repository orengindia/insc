        <div class="container stream">
            <div class="visible-xs col-xs-12 visible-lg col-lg-2 menu">
                ...
                <a href="site/people"><i class="fa fa-angle-double-right"></i> <?php get_text(155)?></a>
                <a href="site/privacy"><?php get_text(40)?></a>
                <a href="site/terms"><?php get_text(61)?></a>
                <?php if(USER_ID!='') { ?>
                    <h3 class="title"><?php get_text(258)?></h3>
                    <p style="padding-left:10px"><b><?php echo $points; ?></b> <?php get_text(39)?></p>
                <?php } ?>
            </div>

            <div class="col-xs-12 col-sm-8 col-lg-7">
                <h3 class="title"><?php get_text(155)?></h3>
