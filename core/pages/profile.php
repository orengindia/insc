<?php
	...
	/* User profile page - with all categories:	 %user_profile% */
	...
	$data['categories_list'] = $engine_session->users_topics($data['profile_id'], 0, 250);
	...
	if($engine_session->profileuserexists($data['profile_id'])!=0) {
		...
		$template_session->loadtpl("profile", $data);
